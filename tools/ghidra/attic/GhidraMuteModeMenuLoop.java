...
public class GhidraMuteModeMenuLoop extends GhidraScript {
    @Override
    public void run() throws Exception {
        long[] targets = { 0x40068efeL, 0x40069022L };
        String[] labels = { "personalize_render", "personalize_dispatch" };
